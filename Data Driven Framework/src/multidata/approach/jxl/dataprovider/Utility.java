...
public class Utility {
	...
	// launch completely
	public static final String BASE_URL = "http://www.facebook.com/";
	...
	// Expected output
	public static final String EXPECT_TITLE = "Login into Facebook | Facebook";
	/*public static final String EXPECT_ERROR = "User or Password is not valid";*/

		// You can change the information of your data file here
	public static final String FILE_PATH = "E:\\Batch 1130\\Data Driven Framework"
			+ "\\src\\multidata\\approach\\jxl\\testData.xls"; // File Path
